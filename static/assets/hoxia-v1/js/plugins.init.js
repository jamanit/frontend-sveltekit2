/* Template Name: Hoxia - Tailwind CSS Web Hosting Template
   Author: Shreethemes
...
try {
    const Default = {
        alwaysOpen: false,
        activeClasses: 'bg-gray-50 dark:bg-slate-800 text-sky-500',
        inactiveClasses: 'text-slate-800 dark:text-white',
        onOpen: () => { },
        onClose: () => { },
        onToggle: () => { }
    }
...
try {
    const Default = {
        defaultTabId: null,
        activeClasses: 'text-white bg-sky-500',
        inactiveClasses: 'hover:text-sky-500 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-slate-800',
        onShow: () => { }
    }
